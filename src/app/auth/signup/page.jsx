  ...
  return (
    <div className="min-h-screen bg-[#080614] flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md bg-[#0d0b1a]/90 border border-neutral-800/60 rounded-2xl p-8 shadow-2xl backdrop-blur-md">
        ...
        <p className="text-sm text-neutral-400 mb-6">Join thousands finding their dream jobs</p>

        {/* Role Toggle */}
        <div className="flex bg-[#161618] rounded-xl p-1 mb-6">
          <button
            onClick={() => setRole("jobseeker")}
            className={`flex-1 py-2 text-sm font-medium rounded-lg transition-all ${
              role === "jobseeker" ? "bg-[#5856d6] text-white" : "text-neutral-400 hover:text-white"
            }`}
          >
            Job Seeker
          </button>
          <button
            ...
            className={`flex-1 py-2 text-sm font-medium rounded-lg transition-all ${
              role === "employer" ? "bg-[#5856d6] text-white" : "text-neutral-400 hover:text-white"
            }`}
          >
            Employer
          </button>
        ...
        <p className="text-center text-sm text-neutral-500 mt-6">
          ...
          <Link href="/auth/signin" className="text-[#5856d6] hover:underline font-medium">
            Sign In
          </Link>
        </p>
